...
impl IsSync for InMemoryProjectRepository {}
impl IsSend for InMemoryProjectRepository {}
...
#[async_trait]
impl ports::ProjectRepository for InMemoryProjectRepository {
    async fn create(&self, data: ports::CreateProjectData<'_>) -> Result<models::Project> {
        ...
        project.id = projects.len() as u64;
